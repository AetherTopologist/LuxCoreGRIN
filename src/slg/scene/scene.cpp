...
static bool GRINIntersectSingleTriangle(const ExtTriangleMesh *mesh, const u_int triIndex,
	...
	xPRIMEray xray(ray.o, ray.d, info.center, info.beta, info.gamma,
					...
					info.rk4_step_init, info.rk4_max_steps,
					info.rk4_step_min, info.rk4_step_max,
					info.rk4_step_curv_k, info.rk4_max_arc_len,
					info.deflect_eps, info.linearize_threshold,
					info.grin_fast_math);
